...
function getStoredTheme() {
  ...
  return localStorage.getItem(STORAGE_KEY) || "warm-sand";
}
...
const appCss = "/assets/styles-Cy4-4zQN.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-display", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground", children: "Página não encontrada. / Page not found." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "mt-6 inline-flex rounded-md bg-primary px-4 py-2 text-sm text-primary-foreground", children: "Voltar / Back" })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl", children: "Algo correu mal / Something went wrong" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
      router2.invalidate();
      reset();
    }, className: "mt-4 rounded-md bg-primary px-4 py-2 text-sm text-primary-foreground", children: "Tentar de novo / Try again" })
  ] }) });
}
...
const $$splitComponentImporter$4 = () => import("./reset-password-CjWUMnRT.js");
const Route$4 = createFileRoute("/reset-password")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component"),
  ssr: false
});
const $$splitComponentImporter$3 = () => import("./profile-jC7ezwJt.js");
const Route$3 = createFileRoute("/profile")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component"),
  ssr: false
});
const $$splitComponentImporter$2 = () => import("./favorites-CfDyK5kM.js");
const Route$2 = createFileRoute("/favorites")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component"),
  ssr: false
});
const $$splitComponentImporter$1 = () => import("./auth-HDw52zzg.js");
const Route$1 = createFileRoute("/auth")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  ssr: false
});
const $$splitComponentImporter = () => import("./index-CKIkErxk.js");
...
const FavoritesRoute = Route$2.update({
  id: "/favorites",
  path: "/favorites",
  getParentRoute: () => Route$5
});
