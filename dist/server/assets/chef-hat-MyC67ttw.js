import { T as reactExports, K as jsxRuntimeExports, R as React } from "./server-bvgxQfr6.js";
import { c as createClient } from "./worker-entry-EldB-nVv.js";
const SUPABASE_URL = "https://dkefvkpphmtoznjdoeoq.supabase.co";
const SUPABASE_PUBLISHABLE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRrZWZ2a3BwaG10b3puamRvZW9xIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzk3MjUyNTYsImV4cCI6MjA5NTMwMTI1Nn0.wsE4XvXShRJmU36s2RrXS42v7Hdok3vbyPimp4w2bPU";
...
const translations = {
  pt: {
    ...
    deleteAccountConfirmation: "Tens a certeza que queres eliminar a conta? Esta ação não pode ser desfeita.",
    ...
    servingsLabel: "Para quantas pessoas?",
    servingsPlaceholder: "ex: 4",
    enterServings: "Indica o número de pessoas",
  ...
  en: {
    ...
    servingsLabel: "How many people?",
    servingsPlaceholder: "e.g. 4",
    enterServings: "Enter the number of people",
    dishName: "Dish name",
...
async function saveUserLanguage(user, lang) {
  if (!user) return;
  try {
...
function useLang() {
  const lang = reactExports.useSyncExternalStore(subscribe, getLang, () => "pt");
...
export {
  ...
  cva as j,
  supabase as k,
  syncUserLanguage as l,
  useLang as m,
  saveUserLanguage as s,
